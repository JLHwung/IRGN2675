...
\setCJKmainfont[Path=fonts/,BSHPUA=BabelStoneHanPUA,ExtH=BabelStoneHan]{BabelStoneHanBeta.ttf}
\setCJKfallbackfamilyfont{\CJKrmdefault}[Path=fonts/]{BabelStoneHanBeta.ttf}
